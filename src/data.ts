...
export const DEFAULT_LANDING_TEXTS: LandingTexts = {
  ...
  betaTitle: "Sertai Sebagai Pembaca Beta",
  betaDesc: "Daftar nama anda untuk berpeluang membaca draf naskhah sastera yang masih dirahsiakan ini. Anda akan dimaklumkan tentang tajuk novel sebelum pelancaran rasmi.",
  launchText: "Bakal Dilancarkan: 1 Januari 2027 • Insya-Allah",
  publisherName: "Maktabah Alkutawi",
  ...
  countdownLabel: "Bakal Terbit",
  insyallahText: "Insya-Allah",
